---
title: Roadmap
description: Strategic roadmap and vision for Snake Evolution.
---
...
- **v1.3.0:** GIF Output & Glass Theme support
...
### Priority 2: Ethical Positioning
...
- [ ] **Export options:** SVG, GIF, Share link
...
- **Free Tier:** All current features, 7 themes, SVG/GIF export.
- **Sponsor Tier ($5/month):** Unlimited custom themes, advanced color editor, priority feedback.
