...
import type t ContributionGridu SnakeState   snakeO@snake-evolutionstypes
} from r
  countContributions
  createSnake,
  eatContribution,
...
function createGridWithContribution(x: number, y: number, level: 1 | 2 | 3 | 4 = 1): ContributionGrid {
